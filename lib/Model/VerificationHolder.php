 ...
 */
class VerificationHolder implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'VerificationHolder';
    ...
    */
     ...
     * Sets ownership
     *
     * @param string|null $ownership Indicates the ownership of the account
     *
     * @return self
     */
