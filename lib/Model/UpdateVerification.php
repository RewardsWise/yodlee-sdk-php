 ...
 */
class UpdateVerification implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UpdateVerification';
    ...
    protected static $openAPIFormats = [
        ...
        'account' => null,
        'transaction' => null,
        'transaction_reference_text' => null,
    ...
    protected static array $openAPINullables = [
        ...
        'account' => false,
        'transaction' => false,
        'transaction_reference_text' => false,
    ...
    protected static $setters = [
        ...
        'transaction_reference_text' => 'setTransactionReferenceText',
    ...
    protected static $getters = [
        ...
        'transaction_reference_text' => 'getTransactionReferenceText',
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('transaction_reference_text', $data ?? [], null);
    ...
    */
    ...
    /**
     * Gets transaction_reference_text
     *
     * @return bool|null
     */
    public function getTransactionReferenceText()
    {
        return $this->container['transaction_reference_text'];
    }

    /**
     * Sets transaction_reference_text
     *
     * @param bool|null $transaction_reference_text A one time reference code of randomly generated 4 digits that is sent along with the single credit transaction and visible in transaction reference field.<br>This is applicable only when single ACH key is enabled.
     *
     * @return self
     */
    public function setTransactionReferenceText($transaction_reference_text)
    {
        if (is_null($transaction_reference_text)) {
            throw new \InvalidArgumentException('non-nullable transaction_reference_text cannot be null');
        }
        $this->container['transaction_reference_text'] = $transaction_reference_text;
