...
/**
 * HoldingTypeListResponse Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class HoldingTypeListResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'HoldingTypeListResponse';
    ...
    */
    ...
    public function setHoldingType($holding_type)
    {
        ...
        if (array_diff($holding_type, $allowedValues)) {
            throw new \InvalidArgumentException(
                sprintf(
                    "Invalid value for 'holding_type', must be one of '%s'",
