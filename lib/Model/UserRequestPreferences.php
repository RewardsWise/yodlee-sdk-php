...
/**
 * UserRequestPreferences Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class UserRequestPreferences implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UserRequestPreferences';
    ...
    */
    ...
    public function setDateFormat($date_format)
    {
        ...
        if ((mb_strlen($date_format) > 2147483647)) {
            throw new \InvalidArgumentException('invalid length for $date_format when calling UserRequestPreferences., must be smaller than or equal to 2147483647.');
        }
        if ((mb_strlen($date_format) < 1)) {
            throw new \InvalidArgumentException('invalid length for $date_format when calling UserRequestPreferences., must be bigger than or equal to 1.');
        }
    ...
    public function setTimeZone($time_zone)
    {
        ...
        if ((mb_strlen($time_zone) > 2147483647)) {
            throw new \InvalidArgumentException('invalid length for $time_zone when calling UserRequestPreferences., must be smaller than or equal to 2147483647.');
        }
        if ((mb_strlen($time_zone) < 1)) {
            throw new \InvalidArgumentException('invalid length for $time_zone when calling UserRequestPreferences., must be bigger than or equal to 1.');
        }
