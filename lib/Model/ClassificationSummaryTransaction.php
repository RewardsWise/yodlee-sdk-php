 ...
 */
class ClassificationSummaryTransaction implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ClassificationSummaryTransaction';
    ...
    */
     ...
     * Sets date
     *
     * @param string|null $date The date the transaction happens in the account
     *
     * @return self
     */
     ...
     * Sets base_type
     *
     * @param string|null $base_type Indicates if the transaction appears as a debit or a credit transaction in the account
     *
     * @return self
     */
