...
/**
 * RenewConsentResponse Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class RenewConsentResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RenewConsentResponse';
    ...
    */
     ...
     * Sets consent_id
     *
     * @param int|null $consent_id Unique identifier for consent. This is created during consent creation.
     *
     * @return self
     */
     ...
     *
     * @param string|null $authorization_url Authorization url generated for the request through PUT Consent to reach endsite.
     *
     * @return self
     */
     ...
     * Sets provider_id
     *
     * @param int|null $provider_id Unique identifier for the provider account resource. This is created during account addition.
     *
     * @return self
     */
