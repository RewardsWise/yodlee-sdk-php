...
class Holding implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'cusip_number' => 'string',
        'asset_classification' => '\OpenAPI\Client\Model\AssetClassification[]',
        ...
        'quantity' => 'float',
        'is_manual' => 'bool',
        'accrued_interest' => '\OpenAPI\Client\Model\Money',
        'grant_date' => 'string',
        'sedol' => 'string',
        ...
        'coupon_rate' => 'float',
        'created_date' => 'string',
        'accrued_income' => '\OpenAPI\Client\Model\Money',
    ...
    protected static $setters = [
        ...
        'asset_classification' => 'setAssetClassification',
    ...
    protected static $getters = [
        ...
        'asset_classification' => 'getAssetClassification',
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('asset_classification', $data ?? [], null);
    ...
    */
    ...
    /**
     * Gets asset_classification
     *
     * @return \OpenAPI\Client\Model\AssetClassification[]|null
     */
    public function getAssetClassification()
    {
        return $this->container['asset_classification'];
    }

    /**
     * Sets asset_classification
     *
     * @param \OpenAPI\Client\Model\AssetClassification[]|null $asset_classification Asset classification applied to the holding. <br><br><b>Applicable containers</b>: investment<br>
     *
     * @return self
     */
    public function setAssetClassification($asset_classification)
    {
        if (is_null($asset_classification)) {
            throw new \InvalidArgumentException('non-nullable asset_classification cannot be null');
        }
        $this->container['asset_classification'] = $asset_classification;
     ...
     * Sets is_manual
     *
     * @param bool|null $is_manual Indicates if a holding is aggregated from a site or it is a manual holding i.e. holding information manually provided by the user.
     *
     * @return self
     */
     ...
     *
     * @param \OpenAPI\Client\Model\Money|null $accrued_interest accrued_interest
     *
     * @return self
     */
     ...
     * Sets accrued_income
     *
     * @param \OpenAPI\Client\Model\Money|null $accrued_income accrued_income
     *
     * @return self
     */
