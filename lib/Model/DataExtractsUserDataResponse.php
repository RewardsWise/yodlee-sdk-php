 ...
 */
class DataExtractsUserDataResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DataExtractsUserDataResponse';
