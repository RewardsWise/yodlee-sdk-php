 ...
 */
class CreateCobrandNotificationEventRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreateCobrandNotificationEventRequest';
