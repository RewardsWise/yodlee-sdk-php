 ...
 */
class ProviderAccountProfile implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ProviderAccountProfile';
    ...
    */
     ...
     * Sets id
     *
     * @param int|null $id Unique identifier for profile<br><br><b>Endpoints</b>:<ul><li>GET providerAccounts/profile</li></ul>
     *
     * @return self
     */
