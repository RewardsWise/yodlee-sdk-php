...
class Links implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets method_type
     *
     * @param string $method_type Type of the HTTP method <br/> GET , PUT , POST , DELETE , ...
     *
     * @return self
     */
     ...
     * Sets rel
     *
     * @param string $rel Get Consent preference
     *
     * @return self
     */
     ...
     * Sets href
     *
     * @param string $href Get Consent preference Endpoint
     *
     * @return self
     */
