...
class HistoricalBalance implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets is_asset
     *
     * @param bool|null $is_asset Indicates whether the balance is an asset or liability.<br><br><b>Aggregated / Manual</b>: Both <br><b>Applicable containers</b>: bank, creditCard, investment, insurance, realEstate, loan<br><b>Endpoints</b>:<ul><li>GET accounts/historicalBalances</li></ul>
     *
     * @return self
     */
     ...
     *
     * @param string|null $data_source_type The source of balance information.<br><br><b>Aggregated / Manual</b>: Both <br><b>Applicable containers</b>: bank, creditCard, investment, insurance, realEstate, loan<br><b>Endpoints</b>:<ul><li>GET accounts/historicalBalances</li></ul><b>Applicable Values</b><br>
     *
     * @return self
     */
