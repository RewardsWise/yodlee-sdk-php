 ...
 */
class VerificationStatus implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'VerificationStatus';
    ...
    protected static $setters = [
        ...
        'single_ach_txn' => 'setSingleAchTxn',
    ...
    protected static $getters = [
        ...
        'single_ach_txn' => 'getSingleAchTxn',
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('single_ach_txn', $data ?? [], null);
    ...
    */
     ...
     * @return bool|null
     */
    public function getSingleAchTxn()
    {
        return $this->container['single_ach_txn'];
    }

    /**
     * Sets single_ach_txn
     *
     * @param bool|null $single_ach_txn As part of account verification, true for we initiate a single credit microentry of $1 for each request and false if we have not initiated single credit microentry of $1 for each request.<br>This field is exposed only for FL4 Users.
     *
     * @return self
     */
    public function setSingleAchTxn($single_ach_txn)
    {
        if (is_null($single_ach_txn)) {
            throw new \InvalidArgumentException('non-nullable single_ach_txn cannot be null');
        }
        $this->container['single_ach_txn'] = $single_ach_txn;
     ...
     *
     * @param int|null $remaining_attempts remaining_attempts
     *
     * @return self
     */
