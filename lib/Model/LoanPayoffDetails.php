 ...
 */
class LoanPayoffDetails implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'LoanPayoffDetails';
    ...
    {
        $this->setIfExists('pay_by_date', $data ?? [], null);
    ...
    */
     ...
     * @return string|null
     */
    public function getPayByDate()
    {
        return $this->container['pay_by_date'];
    }

    /**
     * Sets pay_by_date
     *
     * @param string|null $pay_by_date The date by which the payoff amount should be paid.<br><br><b>Account Type</b>: Aggregated<br><b>Applicable containers</b>: loan<br><b>Endpoints</b>:<ul><li>GET accounts</li><li>GET accounts/{accountId}</li></ul>
     *
     * @return self
     */
    public function setPayByDate($pay_by_date)
    {
        if (is_null($pay_by_date)) {
            throw new \InvalidArgumentException('non-nullable pay_by_date cannot be null');
        }
        $this->container['pay_by_date'] = $pay_by_date;
