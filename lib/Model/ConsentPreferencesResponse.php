 ...
 */
class ConsentPreferencesResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ConsentPreferencesResponse';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['custom_display_data'] === null) {
            $invalidProperties[] = "'custom_display_data' can't be null";
        }
