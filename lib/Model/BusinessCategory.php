 ...
 */
class BusinessCategory implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets category_name
     *
     * @param string|null $category_name The name of the category assigned to the transaction. This is the category field of the transaction category resource. The supported values are provided by the GET transactions/categories.<br><br><b>Applicable containers</b>: bank,creditCard,investment,insurance,loan<br>
     *
     * @return self
     */
