 ...
 */
class DerivedCategorySummary implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DerivedCategorySummary';
    ...
    */
     ...
     * Sets category_name
     *
     * @param string|null $category_name The name of the category.<br><br><b>Applicable containers</b>: creditCard, bank, investment<br>
     *
     * @return self
     */
     ...
     * Sets category_id
     *
     * @param int|null $category_id Id of the category. This information is provided by transactions/categories service.<br><br><b>Applicable containers</b>: creditCard, bank, investment<br>
     *
     * @return self
     */
