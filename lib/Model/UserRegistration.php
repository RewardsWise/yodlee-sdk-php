...
/**
 * UserRegistration Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class UserRegistration implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UserRegistration';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ((mb_strlen($this->container['login_name']) > 150)) {
            $invalidProperties[] = "invalid value for 'login_name', the character length must be smaller than or equal to 150.";
        }

        if ((mb_strlen($this->container['login_name']) < 3)) {
            $invalidProperties[] = "invalid value for 'login_name', the character length must be bigger than or equal to 3.";
        }
    ...
    public function setLoginName($login_name)
    {
        ...
        if ((mb_strlen($login_name) > 150)) {
            throw new \InvalidArgumentException('invalid length for $login_name when calling UserRegistration., must be smaller than or equal to 150.');
        }
        if ((mb_strlen($login_name) < 3)) {
            throw new \InvalidArgumentException('invalid length for $login_name when calling UserRegistration., must be bigger than or equal to 3.');
        }
