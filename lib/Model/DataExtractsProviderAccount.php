 ...
 */
class DataExtractsProviderAccount implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DataExtractsProviderAccount';
    ...
    protected static $openAPIFormats = [
        'destination_provider_account_id' => 'int64',
        ...
        'provider_id' => 'int64',
        'request_id' => null,
        'source_provider_account_ids' => 'int64',
        'id' => 'int64',
        'auth_type' => null,
        'dataset' => null,
        'status' => null
    ...
    protected static array $openAPINullables = [
        'destination_provider_account_id' => false,
        ...
        'provider_id' => false,
        'request_id' => false,
        'source_provider_account_ids' => false,
        'id' => false,
        'auth_type' => false,
        'dataset' => false,
        'status' => false
    ...
    protected static $setters = [
        'destination_provider_account_id' => 'setDestinationProviderAccountId',
        ...
        'source_provider_account_ids' => 'setSourceProviderAccountIds',
        'id' => 'setId',
    ...
    protected static $getters = [
        'destination_provider_account_id' => 'getDestinationProviderAccountId',
        ...
        'source_provider_account_ids' => 'getSourceProviderAccountIds',
        'id' => 'getId',
    ...
    {
        $this->setIfExists('destination_provider_account_id', $data ?? [], null);
        ...
        $this->setIfExists('source_provider_account_ids', $data ?? [], null);
    ...
    */
    ...
    /**
     * Gets destination_provider_account_id
     *
     * @return int|null
     */
    public function getDestinationProviderAccountId()
    {
        return $this->container['destination_provider_account_id'];
    }

    /**
     * Sets destination_provider_account_id
     *
     * @param int|null $destination_provider_account_id The providerAccountId that is retained as part of the many-to-one OAuth migration process.<br><b>Endpoints</b>:<ul><li>GET dataExtracts/userData</li></ul>
     *
     * @return self
     */
    public function setDestinationProviderAccountId($destination_provider_account_id)
    {
        if (is_null($destination_provider_account_id)) {
            throw new \InvalidArgumentException('non-nullable destination_provider_account_id cannot be null');
        }
        $this->container['destination_provider_account_id'] = $destination_provider_account_id;
     ...
     * Sets created_date
     *
     * @param string|null $created_date The date on when the provider account is created in the system.<br><br><b>Endpoints</b>:<ul><li>GET providerAccounts</li><li>POST providerAccounts</li><li>PUT providerAccounts/{providerAccountId}</li><li>GET providerAccounts/{providerAccountId}</li></ul>
     *
     * @return self
     */
     ...
     * Sets is_deleted
     *
     * @param bool|null $is_deleted Indicates if the provider account is deleted from the system.<b>Applicable containers</b>: All Containers<br><b>Aggregated / Manual</b>: Both <br><b>Endpoints</b>:<br><ul><li>GET dataExtracts/userData</li></ul>
     *
     * @return self
     */
    ...
    /**
     * Gets source_provider_account_ids
     *
     * @return int[]|null
     */
    public function getSourceProviderAccountIds()
    {
        return $this->container['source_provider_account_ids'];
    }

    /**
     * Sets source_provider_account_ids
     *
     * @param int[]|null $source_provider_account_ids The providerAccountIds that are deleted and merged into the destinationProviderAccountId as part of the many-to-one OAuth migration process.<br><b>Endpoints</b>:<ul><li>GET dataExtracts/userData</li></ul>
     *
     * @return self
     */
    public function setSourceProviderAccountIds($source_provider_account_ids)
    {
        if (is_null($source_provider_account_ids)) {
            throw new \InvalidArgumentException('non-nullable source_provider_account_ids cannot be null');
        }
        $this->container['source_provider_account_ids'] = $source_provider_account_ids;
