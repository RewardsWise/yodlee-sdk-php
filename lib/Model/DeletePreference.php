...
/**
 * DeletePreference Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class DeletePreference implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DeletePreference';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('alternate_description', $data ?? [], null);
    ...
    */
     ...
     * Sets description
     *
     * @param string|null $description Delete Preference Descritption
     *
     * @return self
     */
     ...
     *
     * @param string|null $alternate_description Delete Preference Alternate Descritption
     *
     * @return self
     */
    public function setAlternateDescription($alternate_description)
    {
        if (is_null($alternate_description)) {
            throw new \InvalidArgumentException('non-nullable alternate_description cannot be null');
        }
     ...
     *
     * @param string|null $label_description Delete Preference LabelDescritption
     *
     * @return self
     */
