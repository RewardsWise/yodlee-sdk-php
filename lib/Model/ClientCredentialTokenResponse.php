 ...
 */
class ClientCredentialTokenResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ClientCredentialTokenResponse';
