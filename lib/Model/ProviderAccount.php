...
class ProviderAccount implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $setters = [
        ...
        'is_real_time_mfa' => 'setIsRealTimeMfa',
    ...
    protected static $getters = [
        ...
        'is_real_time_mfa' => 'getIsRealTimeMfa',
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('is_real_time_mfa', $data ?? [], null);
    ...
    */
    ...
    /**
     * Gets is_real_time_mfa
     *
     * @return bool|null
     */
    public function getIsRealTimeMfa()
    {
        return $this->container['is_real_time_mfa'];
    }

    /**
     * Sets is_real_time_mfa
     *
     * @param bool|null $is_real_time_mfa Attribute to specify whether the user has to input(credentials/MFA) for refreshing an account<br><br><b>Endpoints</b>:<ul><li>GET providerAccounts</li><li>GET providerAccounts/{providerAccountId}</li>
     *
     * @return self
     */
    public function setIsRealTimeMfa($is_real_time_mfa)
    {
        if (is_null($is_real_time_mfa)) {
            throw new \InvalidArgumentException('non-nullable is_real_time_mfa cannot be null');
        }
        $this->container['is_real_time_mfa'] = $is_real_time_mfa;
     ...
     * Sets consent_id
     *
     * @param int|null $consent_id Consent Id generated through POST Consent.<br><br><b>Endpoints</b>:<ul><li>GET providerAccounts</li><li>POST providerAccounts</li><li>PUT providerAccounts/{providerAccountId}</li><li>GET providerAccounts/{providerAccountId}</li></ul>
     *
     * @return self
     */
