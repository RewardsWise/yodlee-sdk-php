 ...
 */
class DerivedCategorySummaryDetails implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DerivedCategorySummaryDetails';
    ...
    */
     ...
     * Sets date
     *
     * @param string|null $date Date on which the credit and debit transactions had occured.<br><br><b>Applicable containers</b>: creditCard, bank, investment<br>
     *
     * @return self
     */
