 ...
 */
class VerificationTransaction implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'VerificationTransaction';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['base_type'] === null) {
            $invalidProperties[] = "'base_type' can't be null";
        }
     ...
     * Sets base_type
     *
     * @param string $base_type base_type
     *
     * @return self
     */
