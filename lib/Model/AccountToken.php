...
class AccountToken implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     *
     * @param string|null $processor_token The unique token that the payment partner can use to make API request to the Envestnet | Yodlee system.
     *
     * @return self
     */
     ...
     * Sets account_id
     *
     * @param int|null $account_id The unique identifier for the user's account.
     *
     * @return self
     */
