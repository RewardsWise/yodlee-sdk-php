...
class Coordinates implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets latitude
     *
     * @param float|null $latitude Latitude of the merchant<br><br><b>Applicable containers</b>: bank,creditCard,loan<br>
     *
     * @return self
     */
     ...
     * Sets longitude
     *
     * @param float|null $longitude Longitude of the merchant<br><br><b>Applicable containers</b>: bank,creditCard,loan<br>
     *
     * @return self
     */
