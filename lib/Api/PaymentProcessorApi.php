...
class PaymentProcessorApi
{
    ...
    {
        list($response) = $this->getVerifiedAccountWithHttpInfo($processor_token, $contentType);
        return $response;
    }

    /**
     * Operation getVerifiedAccountWithHttpInfo
     *
     * Get Account Details
     *
     * @param  string $processor_token Token shared by customer to access financial account information. (required)
    ...
    /**
     * Operation getVerifiedAccountAsync
     *
     * Get Account Details
     *
     * @param  string $processor_token Token shared by customer to access financial account information. (required)
     ...
     */
    public function getVerifiedAccountAsync($processor_token, string $contentType = self::contentTypes['getVerifiedAccount'][0])
    {
        return $this->getVerifiedAccountAsyncWithHttpInfo($processor_token, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getVerifiedAccountAsyncWithHttpInfo
     *
     * Get Account Details
     *
     * @param  string $processor_token Token shared by customer to access financial account information. (required)
    ...
    /**
     * Create request for operation 'getVerifiedAccount'
     *
     * @param  string $processor_token Token shared by customer to access financial account information. (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getVerifiedAccount'] to see the possible values for this operation
     *
     ...
     */
    public function getVerifiedAccountRequest($processor_token, string $contentType = self::contentTypes['getVerifiedAccount'][0])
    {

        // verify the required parameter 'processor_token' is set
        if ($processor_token === null || (is_array($processor_token) && count($processor_token) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $processor_token when calling getVerifiedAccount'
            );
        }


        $resourcePath = '/partner/paymentProcessor/account';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        // header params
        if ($processor_token !== null) {
            $headerParams['processorToken'] = ObjectSerializer::toHeaderValue($processor_token);
        }
    ...
    /**
     * Operation getVerifiedAccountBalance
     *
     * Get Account Balance
     *
     * @param  string $processor_token Token shared by customer to access financial account information. (required)
    ...
    {
        list($response) = $this->getVerifiedAccountBalanceWithHttpInfo($processor_token, $contentType);
        return $response;
    }

    /**
     * Operation getVerifiedAccountBalanceWithHttpInfo
     *
     * Get Account Balance
     *
     * @param  string $processor_token Token shared by customer to access financial account information. (required)
    ...
    /**
     * Operation getVerifiedAccountBalanceAsync
     *
     * Get Account Balance
     *
     * @param  string $processor_token Token shared by customer to access financial account information. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getVerifiedAccountBalanceAsync($processor_token, string $contentType = self::contentTypes['getVerifiedAccountBalance'][0])
    {
        return $this->getVerifiedAccountBalanceAsyncWithHttpInfo($processor_token, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getVerifiedAccountBalanceAsyncWithHttpInfo
     *
     * Get Account Balance
     *
     * @param  string $processor_token Token shared by customer to access financial account information. (required)
    ...
    /**
     * Create request for operation 'getVerifiedAccountBalance'
     *
     * @param  string $processor_token Token shared by customer to access financial account information. (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getVerifiedAccountBalance'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getVerifiedAccountBalanceRequest($processor_token, string $contentType = self::contentTypes['getVerifiedAccountBalance'][0])
    {

        // verify the required parameter 'processor_token' is set
        if ($processor_token === null || (is_array($processor_token) && count($processor_token) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $processor_token when calling getVerifiedAccountBalance'
            );
        }


        $resourcePath = '/partner/paymentProcessor/account/balance';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation getVerifiedAccountHolder
     *
    ...
    {
        list($response) = $this->getVerifiedAccountHolderWithHttpInfo($processor_token, $contentType);
        return $response;
    }

    /**
     * Operation getVerifiedAccountHolderWithHttpInfo
     *
     * Get Account Holder Details
     *
     * @param  string $processor_token Token shared by customer to access financial account information. (required)
    ...
    /**
     * Operation getVerifiedAccountHolderAsync
     *
     * Get Account Holder Details
     *
     * @param  string $processor_token Token shared by customer to access financial account information. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getVerifiedAccountHolderAsync($processor_token, string $contentType = self::contentTypes['getVerifiedAccountHolder'][0])
    {
        return $this->getVerifiedAccountHolderAsyncWithHttpInfo($processor_token, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getVerifiedAccountHolderAsyncWithHttpInfo
     *
     * Get Account Holder Details
     *
     * @param  string $processor_token Token shared by customer to access financial account information. (required)
    ...
    /**
     * Create request for operation 'getVerifiedAccountHolder'
     *
     * @param  string $processor_token Token shared by customer to access financial account information. (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getVerifiedAccountHolder'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getVerifiedAccountHolderRequest($processor_token, string $contentType = self::contentTypes['getVerifiedAccountHolder'][0])
    {

        // verify the required parameter 'processor_token' is set
        if ($processor_token === null || (is_array($processor_token) && count($processor_token) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $processor_token when calling getVerifiedAccountHolder'
            );
        }


        $resourcePath = '/partner/paymentProcessor/account/holder';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
