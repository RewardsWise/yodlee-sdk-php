...
class AccountTokenApi
{
    ...
    /**
     * Operation generatePaymentProcessorToken
     *
    ...
    {
        list($response) = $this->generatePaymentProcessorTokenWithHttpInfo($token_request, $contentType);
        return $response;
    }

    /**
     * Operation generatePaymentProcessorTokenWithHttpInfo
     *
     * Create Account Token
     *
     * @param  \RewardsWise\Yodlee\OpenAPI\Client\Model\PaymentProcessorTokenRequest $token_request account information (required)
    ...
    /**
     * Operation generatePaymentProcessorTokenAsync
     *
     * Create Account Token
     *
     * @param  \RewardsWise\Yodlee\OpenAPI\Client\Model\PaymentProcessorTokenRequest $token_request account information (required)
     ...
     */
    public function generatePaymentProcessorTokenAsync($token_request, string $contentType = self::contentTypes['generatePaymentProcessorToken'][0])
    {
        return $this->generatePaymentProcessorTokenAsyncWithHttpInfo($token_request, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation generatePaymentProcessorTokenAsyncWithHttpInfo
     *
     * Create Account Token
     *
     * @param  \RewardsWise\Yodlee\OpenAPI\Client\Model\PaymentProcessorTokenRequest $token_request account information (required)
     ...
     */
    public function generatePaymentProcessorTokenRequest($token_request, string $contentType = self::contentTypes['generatePaymentProcessorToken'][0])
    {

        // verify the required parameter 'token_request' is set
        if ($token_request === null || (is_array($token_request) && count($token_request) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $token_request when calling generatePaymentProcessorToken'
            );
        }


        $resourcePath = '/paymentProcessor/token';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation revokePaymentProcessorToken
     *
     ...
     * @return void
     */
    public function revokePaymentProcessorToken($processor_token, string $contentType = self::contentTypes['revokePaymentProcessorToken'][0])
    {
        $this->revokePaymentProcessorTokenWithHttpInfo($processor_token, $contentType);
    }

    /**
     * Operation revokePaymentProcessorTokenWithHttpInfo
     *
     * Delete Account Token
     *
     * @param  string $processor_token The token that you want to delete. (required)
     ...
     */
    public function revokePaymentProcessorTokenWithHttpInfo($processor_token, string $contentType = self::contentTypes['revokePaymentProcessorToken'][0])
    {
        $request = $this->revokePaymentProcessorTokenRequest($processor_token, $contentType);
    ...
    /**
     * Operation revokePaymentProcessorTokenAsync
     *
     * Delete Account Token
     *
     * @param  string $processor_token The token that you want to delete. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function revokePaymentProcessorTokenAsync($processor_token, string $contentType = self::contentTypes['revokePaymentProcessorToken'][0])
    {
        return $this->revokePaymentProcessorTokenAsyncWithHttpInfo($processor_token, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation revokePaymentProcessorTokenAsyncWithHttpInfo
     *
     * Delete Account Token
     *
     * @param  string $processor_token The token that you want to delete. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function revokePaymentProcessorTokenAsyncWithHttpInfo($processor_token, string $contentType = self::contentTypes['revokePaymentProcessorToken'][0])
    {
        $returnType = '';
        $request = $this->revokePaymentProcessorTokenRequest($processor_token, $contentType);
    ...
    /**
     * Create request for operation 'revokePaymentProcessorToken'
     *
     * @param  string $processor_token The token that you want to delete. (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['revokePaymentProcessorToken'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function revokePaymentProcessorTokenRequest($processor_token, string $contentType = self::contentTypes['revokePaymentProcessorToken'][0])
    {
        ...
        if ($processor_token === null || (is_array($processor_token) && count($processor_token) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $processor_token when calling revokePaymentProcessorToken'
            );
        }
